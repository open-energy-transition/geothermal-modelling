...
df_eia_gen = pd.read_excel("../Analysis/data/EIA generators/eia8602021/3_1_Generator_Y2021.xlsx",sheet_name='Operable',skiprows=1)
df_eia_plant = pd.read_excel("../Analysis/data/EIA generators/eia8602021/2___Plant_Y2021.xlsx",skiprows=1)
