...
rename_map = {
    ...
    "generator_id": "projectID",
    "operating_year": "DateIn",
    "planned_retirement_year": "DateOut",
    "latitude": "lat",
    "longitude": "lon",
}
...
df_custom_ppl_usa = pd.concat(
    [df_custom_ppl_usa, df_plants_usa_aligned], ignore_index=True
).fillna("")
...
df_custom_ppl_usa["Technology"] = df_custom_ppl_usa["Technology"].replace(
    "hydro", "Reservoir"
)
...
df_custom_ppl_usa.loc[df_custom_ppl_usa["Name"].isin(phs), "Technology"] = (
    "Pumped Storage"
)

df_custom_ppl_usa["Set"] = np.where(
    df_custom_ppl_usa["Technology"] == "Pumped Storage", "Store", "PP"
)
df_custom_ppl_usa
