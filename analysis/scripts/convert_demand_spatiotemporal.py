...
if __name__ == "__main__":
    ...
    Utility_demand_path = pathlib.Path(
        "/Volumes/Sermisha_harddisk/01_OET/14_geothermal_modelling/Outputs/Demand_mapped_v2.geojson"
    )
    ...
    df_n = pypsa.Network(
        "/Volumes/Sermisha_harddisk/01_OET/14_geothermal_modelling/geothermal-modelling/workflow/pypsa-earth/networks/US_2021/elec_s_100flex_ec_lcopt_Co2L-1H.nc"
    )
