...
# Add system paths
sys.path.insert(pypsa_earth_scripts_path)
import build_shapes
...
build_shapes.add_population_data(holes_mapped_intersect_filter,['US'],'standard',nprocesses=2)
...
holes_centroid['Sales (Megawatthours)'] = 0
